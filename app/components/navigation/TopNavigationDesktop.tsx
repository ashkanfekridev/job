        ...
        <nav className="text-lg">
            <div className="flex flex-row justify-between px-4 py-5 mx-auto">
                <div className="flex items-center">
                    ...
                    <li>
                            <a href="#" className="text-black  hover:underline" aria-current="page">Logo😊</a>
                        </li>
                        <li>
                            <a href="#" className="text-black  hover:underline" aria-current="page">Home</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" className="text-black  hover:underline">Support</a>
                        </li>
                    </ul>
                </div>
                {/* <div className="flex items-center">
